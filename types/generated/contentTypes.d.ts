...
export interface ApiBusinessTypeBusinessType extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    features: Schema.Attribute.Component<'shared.business-features', true> &
...
export interface ApiFeatureHighlightsSectionFeatureHighlightsSection
  ...
  info: {
    displayName: 'Feature Highlights Section';
    pluralName: 'feature-highlights-sections';
    singularName: 'feature-highlights-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::feature-highlights-section.feature-highlights-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFeaturesListSectionFeaturesListSection
  extends Struct.SingleTypeSchema {
  collectionName: 'features_list_sections';
  info: {
    displayName: 'Features List Section';
    pluralName: 'features-list-sections';
    singularName: 'features-list-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    groups: Schema.Attribute.Component<'shared.feature-group', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::features-list-section.features-list-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHardwareSectionHardwareSection
  extends Struct.SingleTypeSchema {
  collectionName: 'hardware_sections';
  info: {
    displayName: 'Hardware Section';
    pluralName: 'hardware-sections';
    singularName: 'hardware-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hardware-section.hardware-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeMetaHomeMeta extends Struct.SingleTypeSchema {
  collectionName: 'home_metas';
  info: {
    displayName: 'Home Meta';
    pluralName: 'home-metas';
    singularName: 'home-meta';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomeScreenAppHomeScreenApp extends Struct.SingleTypeSchema {
  collectionName: 'home_screen_apps';
  info: {
    displayName: 'Home Screen App';
    pluralName: 'home-screen-apps';
    singularName: 'home-screen-app';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    header: Schema.Attribute.Component<'shared.header-app', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-screen-app.home-screen-app'
    >;
    moreItems: Schema.Attribute.Component<'shared.home-more-app', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    quickActions: Schema.Attribute.Component<'shared.home-quick-action', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    stats: Schema.Attribute.Component<'shared.stats-app', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPricingBottomSectionPricingBottomSection
  ...
  info: {
    displayName: 'Pricing Bottom Section';
    pluralName: 'pricing-bottom-sections';
    singularName: 'pricing-bottom-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pricing-bottom-section.pricing-bottom-section'
    > &
      Schema.Attribute.Private;
...
export interface ApiPricingHeroPricingHero extends Struct.SingleTypeSchema {
  collectionName: 'pricing_heroes';
  info: {
    displayName: 'Pricing Hero';
    pluralName: 'pricing-heroes';
    singularName: 'pricing-hero';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPricingPlansSectionPricingPlansSection
  ...
  info: {
    ...
    pluralName: 'pricing-plans-sections';
    singularName: 'pricing-plans-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pricing-plans-section.pricing-plans-section'
    > &
      Schema.Attribute.Private;
...
export interface ApiPricingStepsSectionPricingStepsSection
  extends Struct.SingleTypeSchema {
  collectionName: 'pricing_steps_sections';
  info: {
    displayName: 'Pricing Steps Section';
    pluralName: 'pricing-steps-sections';
    singularName: 'pricing-steps-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pricing-steps-section.pricing-steps-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::hardware-section.hardware-section': ApiHardwareSectionHardwareSection;
